def insertLogo(fig,scX,scY,posX,posY):
    fig.layout.images = [dict(source="https://raw.githubusercontent.com/notebook-factory/brand/main/neurolibre-icon-red.png",xref="paper", yref="paper",x=posX+ 0.020, y= -posY + 0.05,
