def insertLogo(fig,scX,scY,posX,posY):
    ...
    fig.add_annotation(x=posX + 0.02,y=posY-0.015*scY,xref="paper",yref="paper",text="<a href=\"https://neurolibre.com\" target=\"_blank\" style=\"color:gray!important\">NeuroLibre</a>",
